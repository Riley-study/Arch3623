...
public class CloudsApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteOrderyIDCall(String cloudId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteOrderyIDValidateBeforeCall(String cloudId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'cloudId' is set
        if (cloudId == null) {
            throw new ApiException("Missing the required parameter 'cloudId' when calling deleteOrderyID(Async)");
        }
        
        com.squareup.okhttp.Call call = deleteOrderyIDCall(cloudId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public Cloud deleteOrderyID(String cloudId) throws ApiException {
        ApiResponse<Cloud> resp = deleteOrderyIDWithHttpInfo(cloudId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Cloud> deleteOrderyIDWithHttpInfo(String cloudId) throws ApiException {
        com.squareup.okhttp.Call call = deleteOrderyIDValidateBeforeCall(cloudId, null, null);
        Type localVarReturnType = new TypeToken<Cloud>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Метод удаления заказа (asynchronously)
     * 
     * @param cloudId Идентификатор заказа облака (required)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteOrderyIDAsync(String cloudId, final ApiCallback<Cloud> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteOrderyIDValidateBeforeCall(cloudId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Cloud>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
